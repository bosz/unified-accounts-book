 ...
 * @author root
 */
public class NjieController implements Initializable {
...
//        }
        ...
        System.out.println("\n ****************ssssss sdoing salary updating\n");
        try {
            usefullstuff.makingMonthlySalaryEntries();
        } catch (SQLException ex) {
            Logger.getLogger(NjieController.class.getName()).log(Level.SEVERE, null, ex);
        }
        System.out.println("******************sssss s end of salary updating\n");
...
//                + " AND njieDB.SUPPLIER_PAY_ORDER.STATUS = " + false;
    ...
    private void payandPrint_payroll(MouseEvent event) throws SQLException, ParseException {
        ...
        qGetSalaryAndTotalPay = "select njieDB.MONTHLY_SALARY_PAYMENT.DAT, "
                ...
                + "                     njieDB.MONTHLY_SALARY_PAYMENT.TOTAL_PAID, "
                + "                     njieDB.MONTHLY_SALARY_PAYMENT.STAFF_ID FROM "
        ...
        if(paymentAmt > possiblePayableAmount ){
            ...
            if (confirmer == Dialog.Actions.YES) {
                try {
                    ...
                    long payrollTotal, payrollSalary, possibleMonthsPayableAmount, staff_id;
                    ...
                    for(int i = 0; i < rowCount; i++){
                        ...
                        staff_id = Integer.parseInt(db.getValueAt(i, 3).toString());
                        ...
                        if(amtDiff < 0){
                            ...
                            qUpdateMontlySalaryPaymentTable = 
                                    ...
                                    + " and njieDB.MONTHLY_SALARY_PAYMENT.STAFF_ID = " + staff_id;
    ...
    private void search_employeeFor_payroll(MouseEvent event) throws SQLException, ParseException {
        ...
        */
        Qstaff_salaryAndName = "SELECT njieDB.MONTHLY_SALARY_PAYMENT.SALARY, njieDB.STAFF.NAME "
                ...
                + " njieDB.MONTHLY_SALARY_PAYMENT.STAFF_ID = " + payroll_staff_id
                + " order by njieDB.MONTHLY_SALARY_PAYMENT.DAT desc";
        ...
        if(possiblePayableAmount == 0){//he cannot take anything since he has 0 balance
            ...
            /*Now, i need to call a method to check for suspensions and subtract from the normal amount 
              and see if that staff can still collect a +ive salary*/
            possiblePayableAmount -= usefullstuff.getSuspensionForStaff(payroll_staff_id);
